...
var vec__30524_30527 = clojure.data.diff(orig_db,new_db);
var only_before_30528 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30524_30527,(0),null);
var only_after_30529 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30524_30527,(1),null);
var db_changed_QMARK__30530 = (cljs.core.some_QMARK_(only_before_30528)) || (cljs.core.some_QMARK_(only_after_30529));
if(db_changed_QMARK__30530){
...
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.array_seq(["only before: ",only_before_30528], 0));

re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.array_seq(["only after : ",only_after_30529], 0));
...
var map__30537 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
var map__30537__$1 = ((((!((map__30537 == null)))?((((map__30537.cljs$lang$protocol_mask$partition0$ & (64))) || (map__30537.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__30537):map__30537);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30537__$1,cljs.core.cst$kw$db);
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30537__$1,cljs.core.cst$kw$event);
...
var map__30545 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
var map__30545__$1 = ((((!((map__30545 == null)))?((((map__30545.cljs$lang$protocol_mask$partition0$ & (64))) || (map__30545.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__30545):map__30545);
var coeffects = map__30545__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30545__$1,cljs.core.cst$kw$event);
...
var len__7629__auto___30548 = arguments.length;
var i__7630__auto___30549 = (0);
while(true){
if((i__7630__auto___30549 < len__7629__auto___30548)){
args__7636__auto__.push((arguments[i__7630__auto___30549]));

var G__30550 = (i__7630__auto___30549 + (1));
i__7630__auto___30549 = G__30550;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__7637__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq30547){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq30547));
});
...
var args__7636__auto__ = [];
var len__7629__auto___30556 = arguments.length;
var i__7630__auto___30557 = (0);
while(true){
if((i__7630__auto___30557 < len__7629__auto___30556)){
args__7636__auto__.push((arguments[i__7630__auto___30557]));

var G__30558 = (i__7630__auto___30557 + (1));
i__7630__auto___30557 = G__30558;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7637__auto__);
});
...
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__30551_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (new_db,old_db,new_ins){
return (function (p1__30552_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(old_db,p1__30552_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq30553){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__30554,G__30555,seq30553__$2);
});
