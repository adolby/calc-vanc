...
if((i < len)){
var k = (ks[i]);
var G__12847 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12848 = (i + (1));
m = G__12847;
i = G__12848;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12852 = c;
var G__12852__$1 = (((G__12852 == null))?null:G__12852.prototype);
if((G__12852__$1 == null)){
return null;
} else {
return (G__12852__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12856 = c;
var G__12856__$1 = (((G__12856 == null))?null:G__12856.prototype);
if((G__12856__$1 == null)){
return null;
} else {
return (G__12856__$1["render"]);
}
})()));
});
...
var G__12860 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12860) : reagent.impl.component.as_element.call(null,G__12860));
};
...
var _STAR_current_component_STAR_12867 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_12867;
}});
...
var G__12875 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__12875) {
...
return ((function (G__12875){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__12878 = reagent.impl.component.state_atom(c);
var G__12879 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__12878,G__12879) : cljs.core.reset_BANG_.call(null,G__12878,G__12879));
});
;})(G__12875))
...
var or__6554__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__12881_12883 = (c["cljsRatom"]);
if((G__12881_12883 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12881_12883);
}
...
if(cljs.core.truth_((function (){var and__6542__auto__ = wrap;
...
var renders_12886 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_12887 = cljs.core.first(cljs.core.vals(renders_12886));
if((cljs.core.count(renders_12886) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_12886))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_12887)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_12887], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__6554__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6554__auto__)){
return or__6554__auto__;
} else {
...
var render_fun__$1 = (function (){var or__6554__auto__ = render_fun;
if(cljs.core.truth_(or__6554__auto__)){
return or__6554__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__6554__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6554__auto__)){
return or__6554__auto__;
} else {
...
var name__$1 = (function (){var G__12885 = name;
switch (G__12885) {
case "":
...
var elem = (function (){var G__12896 = (function (){var or__6554__auto__ = (function (){var G__12898 = c;
if((G__12898 == null)){
return null;
} else {
return (G__12898["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6554__auto__)){
return or__6554__auto__;
...
return (G__12896["_currentElement"]);
}
})();
var name = (function (){var G__12899 = elem;
var G__12899__$1 = (((G__12899 == null))?null:(G__12899["type"]));
if((G__12899__$1 == null)){
return null;
} else {
return (G__12899__$1["displayName"]);
}
})();
var path = (function (){var G__12900 = elem;
var G__12900__$1 = (((G__12900 == null))?null:(G__12900["_owner"]));
var G__12900__$2 = (((G__12900__$1 == null))?null:reagent$impl$component$component_path(G__12900__$1));
if((G__12900__$2 == null)){
return null;
} else {
return [cljs.core.str(G__12900__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__6554__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__6554__auto__)){
return or__6554__auto__;
} else {
var G__12902 = c;
var G__12902__$1 = (((G__12902 == null))?null:G__12902.constructor);
if((G__12902__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12902__$1);
}
}
})();
