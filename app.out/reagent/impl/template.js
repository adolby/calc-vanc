...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7160__auto__,writer__7161__auto__,opt__7162__auto__){
return cljs.core._write(writer__7161__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__12932 = o;
(G__12932[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__12933__delegate = function (args){
...
while (G__12934__i < G__12934__a.length) {G__12934__a[G__12934__i] = arguments[G__12934__i + 0]; ++G__12934__i;}
  args = new cljs.core.IndexedSeq(G__12934__a,0);
} 
...
if(cljs.core.truth_((function (){var and__6542__auto__ = cljs.core.some_QMARK_(reagent.impl.template.find_dom_node);
if(and__6542__auto__){
var and__6542__auto____$1 = cljs.core.some_QMARK_(jsprops);
if(and__6542__auto____$1){
var and__6542__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__12940 = jsprops;
(G__12940["defaultValue"] = value);

(G__12940["onChange"] = ((function (G__12940,v,value,on_change){
return (function (p1__12938_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12938_SHARP_);
});})(G__12940,v,value,on_change))
);
...
var vec__12947 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12947,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12947,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12947,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___12952 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12952 == null)){
} else {
var key_12953 = temp__4661__auto___12952;
(jsprops["key"] = key_12953);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12955 = (new reagent.impl.template.NativeWrapper());
(G__12955["name"] = c);
...
var G__12957 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12957) : reagent.impl.template.as_element.call(null,G__12957));
} else {
...
var len__7629__auto___12963 = arguments.length;
var i__7630__auto___12964 = (0);
while(true){
if((i__7630__auto___12964 < len__7629__auto___12963)){
args__7636__auto__.push((arguments[i__7630__auto___12964]));

var G__12965 = (i__7630__auto___12964 + (1));
i__7630__auto___12964 = G__12965;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7637__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12961){
var G__12962 = cljs.core.first(seq12961);
var seq12961__$1 = cljs.core.next(seq12961);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12962,seq12961__$1);
});
...
break;
default:
var G__12969 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12969;
continue;
...
var n__7469__auto___12972 = a.length;
var i_12973 = (0);
while(true){
if((i_12973 < n__7469__auto___12972)){
(a[i_12973] = reagent.impl.template.as_element((a[i_12973])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7469__auto___12975 = a.length;
var i_12976 = (0);
while(true){
if((i_12976 < n__7469__auto___12975)){
var val_12977 = (a[i_12976]);
if((cljs.core.vector_QMARK_(val_12977)) && ((reagent.impl.template.key_from_vec(val_12977) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12976] = reagent.impl.template.as_element(val_12977));

var G__12978 = (i_12976 + (1));
i_12976 = G__12978;
continue;
} else {
}
...
var ctx = {};
var vec__12982 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12982,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12982,(1),null);
...
var G__12986 = (cljs.core.count(argv) - first_child);
switch (G__12986) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12986){
